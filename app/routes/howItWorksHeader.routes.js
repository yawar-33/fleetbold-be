...
const controller = require('../controllers/howItWorksHeader.controller');
...
router.get('/howItWorks-section', controller.getCompleteHowItWorkSection
    
);

// Header management only
router.get('/howItWorks-header', controller.getHeader);
router.put('/howItWorks-header', controller.updateHeader);

// Optional: Manual reordering of benefits
router.put('/howItWorks-benefits/reorder', controller.reorderBenefits);
